...
func main() {
	...
	exec_res = execSQL(db, "CREATE TABLE IF NOT EXISTS hty_friend ( `user_id` INT NOT NULL, `friend_id` INT NOT NULL, `user_group` VARCHAR ( 10 ) NOT NUL·L, `friend_group` VARCHAR ( 10 ) NOT NULL );")
	fmt.Println(exec_res.RowsAffected())
